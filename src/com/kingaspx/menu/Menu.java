...
import com.kingaspx.util.SoundCreator;
...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kGradientPanel1.setkEndColor(new java.awt.Color(66, 66, 66));
        kGradientPanel1.setkStartColor(new java.awt.Color(5, 5, 5));

        kButton1.setText("Play");
        kButton1.setkAllowGradient(false);
        kButton1.setkAllowTab(false);
        kButton1.setkBackGroundColor(new java.awt.Color(38, 204, 129));
        kButton1.setkHoverColor(new java.awt.Color(33, 173, 110));
        kButton1.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        kButton1.setkPressedColor(new java.awt.Color(25, 139, 88));
        ...
        jLabel1.setText("Qual idioma?");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "es-LA_SofiaVoice", "en-US_MichaelV2Voice", "pt-BR_IsabelaVoice" }));
        jComboBox1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 204, 204));
        jLabel3.setText("Escreva aqui o que você quiser, eu vou dizer tudo!");
        ...
        setSize(new java.awt.Dimension(426, 249));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        SoundCreator sc = new SoundCreator();
        sc.create_audio(name_label.getText(), (String) jComboBox1.getSelectedItem());
